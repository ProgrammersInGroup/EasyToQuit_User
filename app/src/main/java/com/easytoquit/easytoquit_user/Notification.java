...
import com.easytoquit.easytoquit_user.Insertion.InsertAssessment;
...
*/
    ...
    public static void showFullScreen(Context context){
        ...
        //Intent mIntent = new Intent(Intent.ACTION_PICK_ACTIVITY, InsertAssessment.class);
        //Intent intent = new Intent().setClass(context, InsertAssessment.class);
        ...
        hangIntent.setClass(context, InsertAssessment.class);
